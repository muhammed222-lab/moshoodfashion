...
const Footer = () => {
  ...
  const footerSections = {
    ...
    Assist: [
      { name: "Track my order", href: "/profile" },
      { name: "Pick up", href: "mailto:moshoodfashionhome@gmail.com" },
    ],
  };
  ...
  const handleSubscribe = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log("Subscription integration response:", data);
      setSuccessMessage("Subscription added successfully. Thank you!");
      setEmail("");
